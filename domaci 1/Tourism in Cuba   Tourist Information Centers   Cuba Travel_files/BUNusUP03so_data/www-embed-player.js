...
r(Ig,vg);var Eg=new wg("screen-created",Ig),Jg=[],Kg=0;function Lg(a,b,c){var d=Mg;b={csn:a,parentVe:tg(b),childVes:La(c,function(f){return tg(f)})};
...
r(gh,K);gh.prototype.m=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.nb)}K.prototype.m.call(this)};var hh=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function ih(a){a=a||"";if(window.spf){var b=a.match(hh);spf.style.load(a,b?b[1]:"",void 0)}else jh(a)}
...
r(mh,K);m=mh.prototype;m.getId=function(){return this.U};
...
c=q(c);for(d=c.next();!d.done;d=c.next())Uh(a,d.value);return a}
...
function Wh(a,b){for(var c=q(b),d=c.next();!d.done;d=c.next())d=d.value,Th(d)?a.push(Uh({},d)):Vh(d)?a.push(Wh([],d)):a.push(d);return a}
function Th(a){return"object"===typeof a&&!Array.isArray(a)}
function Vh(a){return"object"===typeof a&&Array.isArray(a)}
;function Xh(){var a=y("ytcsi.debug");a||(a=[],x("ytcsi.debug",a,void 0),x("ytcsi.reference",{},void 0));return a}
function Yh(){var a=y("ytcsi.reference");a||(Xh(),a=y("ytcsi.reference"));if(a[""])return a[""];var b={timerName:"",info:{},tick:{}};Xh().push(b);return a[""]=b}
;function Zh(a,b,c){c=void 0===c?{}:c;var d=Mg;O("ytLoggingEventsDefaultDisabled",!1)&&Mg==Mg&&(d=null);rg(a,b,d,c)}
;var $h=y("ytLoggingLatencyUsageStats_")||{};x("ytLoggingLatencyUsageStats_",$h,void 0);var ai=0;function bi(a){$h[a]=$h[a]||{count:0};var b=$h[a];b.count++;b.time=U();ai||(ai=sf(ci,0,5E3));if(5<b.count){if(6==b.count&&1>1E5*Math.random()){b=0==a.indexOf("info")?"WARNING":"ERROR";var c=Error("CSI data exceeded logging limit with key");c.params=a;Qe(c,b)}return!0}return!1}
function ci(){var a=U(),b;for(b in $h)6E4<a-$h[b].time&&delete $h[b];ai=0}
;function di(a){a=Error.call(this,a);this.message=a.message;"stack"in a&&(this.stack=a.stack)}
r(di,Error);var Y={},ei=(Y.ad_allowed="adTypesAllowed",Y.yt_abt="adBreakType",Y.ad_cpn="adClientPlaybackNonce",Y.ad_docid="adVideoId",Y.yt_ad_an="adNetworks",Y.ad_at="adType",Y.browse_id="browseId",Y.p="httpProtocol",Y.t="transportProtocol",Y.cpn="clientPlaybackNonce",Y.cseg="creatorInfo.creatorSegment",Y.csn="clientScreenNonce",Y.docid="videoId",Y.GetHome_rid="getHomeRequestId",Y.is_continuation="isContinuation",Y.is_nav="isNavigation",Y.b_p="kabukiInfo.browseParams",Y.is_prefetch="kabukiInfo.isPrefetch",Y.is_secondary_nav=
...
Y.yt_pre="playerInfo.preloadType",Y.yt_ad_pr="prerollAllowed",Y.pa="previousAction",Y.yt_red="isRedSubscriber",Y.st="serverTimeMs",Y.aq="tvInfo.appQuality",Y.br_trs="tvInfo.bedrockTriggerState",Y.label="tvInfo.label",Y.is_mdx="tvInfo.isMdx",Y.preloaded="tvInfo.isPreloaded",Y.upg_player_vis="playerInfo.visibilityState",Y.query="unpluggedInfo.query",Y.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",Y.yt_vst="videoStreamType",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y.rcl=
"mwebInfo.responseContentLength",Y.GetSettings_rid="mwebInfo.getSettingsRequestId",Y),fi="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),gi={},hi=(gi.mver="MEASUREMENT_VERSION_",gi.pis="PLAYER_INITIALIZED_STATE_",gi.yt_pt="LATENCY_PLAYER_",gi.pa="LATENCY_ACTION_",gi.yt_vst="VIDEO_STREAM_TYPE_",gi),ii="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts tds ytu_pvis rce".split(" ");
function ji(){return Q("csi_on_gel")||!!Ph(void 0).useGel}
function ki(){var a=Ph(void 0);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function li(){Oh().yt_lt="hot_bg";if(ji()){var a="hot_bg";var b=ki();if(b.gelInfos)b.gelInfos.info_yt_lt=!0;else{var c={};b.gelInfos=(c.info_yt_lt=!0,c)}if("yt_lt"in ei){b=ei.yt_lt;0<=Ja(fi,b)&&(a=!!a);"yt_lt"in hi&&"string"===typeof a&&(a=hi.yt_lt+a.toUpperCase());b=b.split(".");for(var d=c={},e=0;e<b.length-1;e++){var f=b[e];d[f]={};d=d[f]}d[b[b.length-1]]=a;a=Sh({},c)}else 0<=Ja(ii,"yt_lt")||(a=new di("Unknown label logged with GEL CSI"),a.params={label:"yt_lt"},fe(a)),a=void 0;a&&ji()&&(b=Yh(),
Sh(b.info,a),b=ki(),"gelInfos"in b||(b.gelInfos={}),Sh(b.gelInfos,a),b=Qh(),c=Object.keys(a).join(""),bi("info_"+c+"_"+b)||(a.clientActionNonce=b,Zh("latencyActionInfo",a)))}else Yh().info.yt_lt="hot_bg"}
;var mi={vc:!0};function ni(){if(!ji()){var a=Mh(void 0),b=Oh(),c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&z(a[f])){var d=f.slice(1);if(d in mi){var e=La(a[f],function(l){return Math.round(l-c)});
b["all_"+d]=e.join()}delete a[f]}e=O("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:O("TIMING_ACTION",void 0)};d=b.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var g=window.location.protocol+y("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?b.h5jse=Math.round(b.h5jse-g.responseEnd):delete b.h5jse}a.aft=Lh();Nh()&&"youtube"==e&&(li(),e=a.vc,g=a.pbs,delete a.aft,b.aft=Math.round(g-e));for(var h in b)"_"!=h.charAt(0)&&(f[h]=b[h]);a.ps=U();h={};e=[];for(var k in a)"_"!=
...
r(ti,si);function ui(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(hd(a),d.i))}}
...
r(vi,K);m=vi.prototype;m.start=function(){this.j||this.g||(this.j=!0,ui(this.f,"RECEIVING"))};
...
r(zi,vi);zi.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
...
r(Ai,K);Ai.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.w)}catch(e){P(e,"WARNING")}}};
...
r(Ii,D);function Ji(){this.g=0;this.f=null}
...
r(Mi,D);Mi.prototype.name="BiscottiError";function Ni(){D.call(this,"Biscotti ID is missing from server")}
r(Ni,D);Ni.prototype.name="BiscottiMissingError";var Hi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Oi=null;function ce(){if("1"===Ta(ae(),"args","privembed"))return sd(Error("Biscotti ID is not available in private embed mode"));Oi||(Oi=ud(Gi().then(Pi),function(a){return Qi(2,a)}));
return Oi}
...
xa(Ui);var Yi=null,Zi=null,$i=null,aj={};function bj(a){var b=a.id;a=a.ve_type;var c=ug++;a=new sg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});aj[b]=a;b=ch();c=bh();b&&c&&Lg(b,c,[a])}
function cj(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(dh(b,a),a=bh()))for(var c in aj){var d=aj[c];d&&Lg(b,a,[d])}}
function dj(a){aj[a.id]=new sg({trackingParams:a.tracking_params})}
function ej(a){var b=ch(),c=aj[a.id];if(b&&c){a=Mg;c={csn:b,ve:tg(c),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var d={ca:void 0,P:b};"UNDEFINED_CSN"==b?Ng("visualElementGestured",c,d):rg("visualElementGestured",c,a,d)}}
function fj(a){a=a.ids;var b=ch();if(b)for(var c=0;c<a.length;c++){var d=aj[a[c]];if(d){var e=Mg;d={csn:b,ve:tg(d),eventType:1};var f={ca:void 0,P:b};"UNDEFINED_CSN"==b?Ng("visualElementShown",d,f):rg("visualElementShown",d,e,f)}}}
...
var gj=ee(function(){var a=Mh(void 0),b;(b=!Q("use_first_tick"))||(b=!("ol"in Mh(void 0)));if(b&&(b="ol",X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b)),b=U(),a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b)),a.ol=b,a=ki(),a.gelTicks&&(a.gelTicks.tick_ol=!0),U(),ji()?(Yh().tick.ol=void 0,a=Qh(),bi("tick_ol_"+a)||Zh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),Rh(),a=!0):a=!1,!a)){if(!y("yt.timing.pingSent_")&&(b=O("TIMING_ACTION",void 0),a=Mh(void 0),y("ytglobal.timingready_")&&
b&&a._start&&Lh())){Rh();b=!0;var c=O("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&ni()}Yh().tick.ol=void 0}a=Ui.getInstance();c=!!((Xi("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Xc(document.body,"exp-invert-logo")&&(b&&!Xc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Xc(d,"inverted-hdpi")||(e=Vc(d),Wc(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi")))):!b&&Xc(document.body,
"inverted-hdpi")&&Yc());c!=b&&(c="f"+(Math.floor(119/31)+1),d=Xi(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),hj=ee(function(){var a=Yi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&Bf.dispose();a=0;for(var b=uf.length;a<b;a++){var c=uf[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}uf.length=0;of("//static.doubleclick.net/instream/ad_status.js");vf=!1;N("DCLKSTAT",0);Uc($i,Zi);if(a=Yi)a.removeEventListener("onScreenChanged",cj),a.removeEventListener("onLogClientVeCreated",bj),a.removeEventListener("onLogServerVeCreated",dj),a.removeEventListener("onLogVeClicked",ej),a.removeEventListener("onLogVesShown",
fj),a.destroy();aj={}});
window.addEventListener?(window.addEventListener("load",gj),window.addEventListener("unload",hj)):window.attachEvent&&(window.attachEvent("onload",gj),window.attachEvent("onunload",hj));Ha("yt.abuse.player.botguardInitialized",y("yt.abuse.player.botguardInitialized")||Hf);Ha("yt.abuse.player.invokeBotguard",y("yt.abuse.player.invokeBotguard")||If);Ha("yt.abuse.dclkstatus.checkDclkStatus",y("yt.abuse.dclkstatus.checkDclkStatus")||xf);
